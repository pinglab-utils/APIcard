...
- Use the scanpy API to pull lists of marker genes for specific cell types.
- We will then use the PyBio Mart method for querying biomart databases using Python to
