...
Identify existing drugs that may be effective for monogenic Mendelian disorders
...
Identify existing medications that target Mendelian disease genes or genes that interact with Mendelian disease genes
